...
public class Controler
{
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			List<ObservationEntity> obsList = JSONEndpoint.parseObservations("./src/test/temperature.txt");
			...
			obsList = JSONEndpoint.parseObservations("./src/test/tempm.txt");
			String humidityURI = c.model.getEntityURI("Temperature").get(0);
